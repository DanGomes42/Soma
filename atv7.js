...
function picotelaria() {
    /**
     * @param {number} value Preço sem estilização 
     * @returns {string} valor formatado ex: R$ 10,00
     */
    const formatarParaReal = value => value.toLocaleString('pt-BR', { currency: 'BRL' })
    ...
    button.addEventListener('click', () => {
        ...
        texto.innerText = `O preço será de R$${formatarParaReal(preco)}`
